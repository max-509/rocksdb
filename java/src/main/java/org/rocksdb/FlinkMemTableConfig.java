 ...
 */
public class FlinkMemTableConfig extends MemTableConfig {
  ...
  /**
   * FlinkMemTableConfig constructor
   */
  public FlinkMemTableConfig() {
   ...
   * @return the reference to the current FlinkMemTableConfig.
   */
  public FlinkMemTableConfig setStartKeyGroup(
   ...
   * @return the reference to the current FlinkMemTableConfig.
   */
  public FlinkMemTableConfig setNumKeyGroups(
   ...
   * @return the reference to the current FlinkMemTableConfig.
   */
  public FlinkMemTableConfig setKeyGroupBytes(
   ...
   * @return the reference to the current FlinkMemTableConfig.
   */
  public FlinkMemTableConfig setHeight(final int height) {
    height_ = height;
    return this;
  }
   ...
   * @return the reference to the current FlinkMemTableConfig.
   */
  public FlinkMemTableConfig setBranchingFactor(
      final int bf) {
    branchingFactor_ = bf;
    return this;
  }
